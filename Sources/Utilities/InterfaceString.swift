...
struct InterfaceString {
    ...
    struct Tab {
        struct PopupTitle {
            static let Discover: String = NSLocalizedString(
                "Discover",
                comment: "Discover pop up title"
            )
            static let Notifications: String = NSLocalizedString(
                "Notifications",
                comment: "Notifications pop up title"
            )
            static let Following: String = NSLocalizedString(
                "Following",
                comment: "Stream pop up title"
            )
            static let Profile: String = NSLocalizedString(
                "Your Profile",
                comment: "Profile pop up title"
            )
        ...
        struct PopupText {
            static let Discover: String = NSLocalizedString(
                "What's next in art, design, fashion, web culture & more.",
                comment: "Discover pop up text"
            )
            static let Notifications: String = NSLocalizedString(
                "Stay hyped with real-time alerts.",
                comment: "Notifications pop up text"
            )
            static let Following: String = NSLocalizedString(
                "Follow the people, work & ideas that you think are most rad.",
                comment: "Stream pop up text"
            )
            static let Profile: String = NSLocalizedString(
                "Your deets & posts in one place. All your settings too.",
                comment: "Profile pop up text"
            )
            static let Omnibar: String = NSLocalizedString(
                "Publish images, GIFs, text, links and more.",
                comment: "Omnibar pop up text"
            )
        }
    }
    ...
    struct Editorials {
        ...
        static let JoinCaption: String = NSLocalizedString(
            "Be part of what’s next in art, design, fasion, web, culture & more.",
            comment: ""
        )
        ...
        static let InviteInstructions: String = NSLocalizedString(
            "Invite as many people as you want, just separate their email addresses with commas.",
            comment: ""
        )
        static let InvitePlaceholder: String = NSLocalizedString(
    ...
    struct ArtistInvites {
        ...
        static let SubmissionsError: String = NSLocalizedString(
            "Error while loading submissions",
            comment: ""
        )
        ...
        static let SelectingStatus: String = NSLocalizedString(
            "Selections In Progress",
            comment: ""
        )
        static let ClosedStatus: String = NSLocalizedString("Invite Closed", comment: "")
        static let SubmissionJoinPrompt: String = NSLocalizedString(
            "To submit to an Invite you first need to create an Ello account.",
            comment: ""
        )
        static let SubmissionSuccessTitle: String = NSLocalizedString(
            "Submission received!",
            comment: ""
        )
        static let SubmissionSuccessDescription: String = NSLocalizedString(
            "Our team of curators will review your submission and you’ll recieve a notification when it is accepted.",
            comment: ""
        )
        ...
        static let AdminApprovedStream: String = NSLocalizedString(
            "Accepted submissions",
            comment: ""
        )
        static let AdminSelectedStream: String = NSLocalizedString(
            "Selected submissions",
            comment: ""
        )
        static let AdminDeclinedStream: String = NSLocalizedString(
    ...
    struct Discover {
        ...
        static let Subscribed: String = NSLocalizedString(
            "Subscribed",
            comment: "Subscribed Categories title"
        )
        static let Subscribe: String = NSLocalizedString(
            "Subscribe",
            comment: "Subscribe Categories title"
        )

        static let ZeroState: String = NSLocalizedString(
            "Choose communities to subscribe to here.",
            comment: ""
        )
        static let ZeroState1: String = NSLocalizedString(
            "Choose communities to subscribe to ",
            comment: ""
        )
    ...
    struct Search {
        ...
        static let FindFriendsPrompt: String = NSLocalizedString(
            "Help grow the Ello community.",
            comment: "Search zero state button title"
        )
        static let NoMatches: String = NSLocalizedString(
            "We couldn't find any matches.",
            comment: "No search results found title"
        )
        static let TryAgain: String = NSLocalizedString(
            "Try another search?",
            comment: "No search results found body"
        )
    }
    ...
    struct Drawer {
        ...
        static let Pinterest: String = NSLocalizedString("Pinterest", comment: "")
        static let Tumblr: String = NSLocalizedString("Tumblr", comment: "")
        static let Medium: String = NSLocalizedString("Medium", comment: "")
        ...
        static let Version: String = {
            ...
            return NSLocalizedString(
                "Ello v\(marketingVersion) b\(buildVersion)",
    ...
    struct Community {
        static let Choose: String = NSLocalizedString("Choose Category", comment: "")
        static let Search: String = NSLocalizedString("Search Categories", comment: "")
    }
    ...
    struct Settings {
        static let EditProfile: String = NSLocalizedString("Edit Profile", comment: "")
        static let EditCredentials: String = NSLocalizedString("Edit Credentials", comment: "")
        static let CredentialsSettings: String = NSLocalizedString(
            "To change your username, email, or password, please verify your current password",
            comment: ""
        )
        static let TapToEdit: String = NSLocalizedString("(tap to edit)", comment: "")
        static let AbortChanges: String = NSLocalizedString("Discard changes?", comment: "")
        static let Logout: String = NSLocalizedString("Logout", comment: "")
        static let Profile: String = NSLocalizedString("Profile", comment: "")
        static let ProfileDescription: String = NSLocalizedString(
            "Your name, username, bio and links appear on your public profile. Your email address remains private.",
            comment: "Profile Privacy Description"
        )
        static let CommunityInfo: String = NSLocalizedString("Community Info", comment: "")
        static let Username: String = NSLocalizedString("Username", comment: "")
        static let Email: String = NSLocalizedString("Email", comment: "")
        static let OldPassword: String = NSLocalizedString("Current Password", comment: "")
        static let OldPasswordRequired: String = NSLocalizedString(
            "You must enter your current password to change your username, email, or password.",
            comment: ""
        )
        static let Password: String = NSLocalizedString("Password", comment: "")
        static let Name: String = NSLocalizedString("Name", comment: "")
        static let Bio: String = NSLocalizedString("Bio", comment: "")
        static let Links: String = NSLocalizedString("Links", comment: "")
        static let Location: String = NSLocalizedString("Location", comment: "")
        static let AvatarUploaded: String = NSLocalizedString(
            "You’ve updated your Avatar.\n\nIt may take a few minutes for your new avatar to appear on Ello, so please be patient. It’ll be live soon!",
            comment: "Avatar updated copy"
        )
        static let CoverImageUploaded: String = NSLocalizedString(
            "You’ve updated your Header.\n\nIt may take a few minutes for your new header to appear on Ello, so please be patient. It’ll be live soon!",
            comment: "Cover Image updated copy"
        )
        static let CreatorType: String = NSLocalizedString("Creator Type", comment: "")
        static let BlockedTitle: String = NSLocalizedString("Blocked", comment: "")
        static let MutedTitle: String = NSLocalizedString("Muted", comment: "")
        static let DeleteAccountTitle: String = NSLocalizedString("Account Deletion", comment: "")
        static let DeleteAccount: String = NSLocalizedString("Delete Account", comment: "")
        static let DeleteAccountExplanation: String = NSLocalizedString(
            "By deleting your account you remove your personal information from Ello. Your account cannot be restored.",
            comment: ""
        )
        static let DeleteAccountConfirm: String = NSLocalizedString(
            "Delete Account?",
            comment: "delete account question"
        )
        static let AccountIsBeingDeleted: String = NSLocalizedString(
            "Your account is in the process of being deleted.",
            comment: ""
        )
    ...
    struct Profile {
        ...
        static let Collaborate: String = NSLocalizedString(
            "Collab",
            comment: "Collaborate button title"
        )
        ...
        static let EditProfile: String = NSLocalizedString(
            "Edit Profile",
            comment: "Edit Profile button title"
        )
        static let PostsCount: String = NSLocalizedString("Posts", comment: "Posts count header")
        static let FollowingCount: String = NSLocalizedString(
            "Following",
            comment: "Following count header"
        )
        static let FollowersCount: String = NSLocalizedString(
            "Followers",
            comment: "Followers count header"
        )
        static let LovesCount: String = NSLocalizedString("Loves", comment: "Loves count header")
        static let CurrentUserNoResultsTitle: String = NSLocalizedString(
            "Welcome to your Profile",
            comment: ""
        )
        static let CurrentUserNoResultsBody: String = NSLocalizedString(
            "Everything you post lives here!\n\nThis is the place to find everyone you’re following and everyone that’s following you. You’ll find your Loves here too!",
            comment: ""
        )
        static let NoResultsTitle: String = NSLocalizedString(
            "This person hasn't posted yet.",
            comment: ""
        )
        static let NoResultsBody: String = NSLocalizedString(
            "Follow or mention them to help them get started!",
            comment: ""
        )
        static let FeaturedIn: String = NSLocalizedString(
            "Featured in",
            comment: "Featurd in label"
        )
    ...
    struct Post {
        static let DefaultTitle: String = NSLocalizedString(
            "Post Detail",
            comment: "Default post title"
        )
        static let LovedByList: String = NSLocalizedString(
            "Loved by",
            comment: "Loved by list title"
        )
        static let RepostedByList: String = NSLocalizedString(
            "Reposted by",
            comment: "Reposted by list title"
        )
        static let RelatedPosts: String = NSLocalizedString(
            "Related Posts",
            comment: "Related posts title"
        )
        static let LoadMoreComments: String = NSLocalizedString(
            "Load More",
            comment: "Load More Comments title"
        )
        ...
        static let AddedTo: String = NSLocalizedString("Added to", comment: "")
        static let PostedInto: String = NSLocalizedString("Posted into", comment: "")

        static let CreateComment: String = NSLocalizedString(
            "Comment...",
            comment: "Create Comment Button Prompt"
        )
        static let DeletePostConfirm: String = NSLocalizedString(
            "Delete Post?",
            comment: "Delete Post confirmation"
        )
        static let DeleteCommentConfirm: String = NSLocalizedString(
            "Delete Comment?",
            comment: "Delete Comment confirmation"
        )
        static let RepostConfirm: String = NSLocalizedString(
            "Repost?",
            comment: "Repost confirmation"
        )
        static let RepostSuccess: String = NSLocalizedString(
            "Success!",
            comment: "Successful repost alert"
        )
        static let RepostError: String = NSLocalizedString(
            "Could not create repost",
            comment: "Could not create repost message"
        )
        static let CannotEditPost: String = NSLocalizedString(
            "Looks like this post was created on the web!\n\nThe videos and embedded content it contains are not YET editable on our iOS app.  We’ll add this feature soon!",
            comment: "Uneditable post error message"
        )
        static let CannotEditComment: String = NSLocalizedString(
            "Looks like this comment was created on the web!\n\nThe videos and embedded content it contains are not YET editable on our iOS app.  We’ll add this feature soon!",
            comment: "Uneditable comment error message"
        )
    }

    struct Omnibar {
        static let SayEllo: String = NSLocalizedString("Say Ello...", comment: "Say Ello prompt")
        static let AddMoreText: String = NSLocalizedString(
            "Add more text...",
            comment: "Add more text prompt"
        )
        ...
        static let ChooseCommunity: String = NSLocalizedString("Choose Category", comment: "")
        ...
        static let CannotComment: String = NSLocalizedString(
            "This user has disabled comments.",
            comment: ""
        )
        static let TooLongError: String = NSLocalizedString(
            "Your text is too long.\n\nThe character limit is 5,000.",
            comment: "Post too long (maximum characters is 5000) error message"
        )
        ...
        static let UpdatingComment: String = NSLocalizedString(
            "Updating your comment…",
            comment: ""
        )
        static let CreatingPost: String = NSLocalizedString("Creating your post…", comment: "")
        static let CreatingComment: String = NSLocalizedString(
            "Creating your comment…",
            comment: ""
        )
        static let CreatedPost: String = NSLocalizedString(
            "Post successfully created!",
            comment: ""
        )
        static let CreatedComment: String = NSLocalizedString(
            "Comment successfully created!",
            comment: ""
        )
        static let SellYourWorkTitle: String = NSLocalizedString(
            "Sell your work",
            comment: "Sell your work title"
        )
        static let ProductLinkPlaceholder: String = NSLocalizedString(
            "Product detail URL",
            comment: "Product detail URL prompt"
        )
    }
    ...
    struct Relationship {
        ...
        static let Following: String = NSLocalizedString(
            "Following",
            comment: "Following relationship"
        )
        ...
        static let UnmuteButton: String = NSLocalizedString(
            "Unmute",
            comment: "Unmute button title"
        )
        static let BlockButton: String = NSLocalizedString("Block", comment: "Block button title")
        static let UnblockButton: String = NSLocalizedString(
            "Unblock",
            comment: "Unblock button title"
        )
        ...
        static func MuteWarning(atName: String) -> String {
            return String.localizedStringWithFormat(
                "%@ will not be able to comment on your posts. If %@ mentions you, you will not be notified.",
                atName,
                atName
            )
        }
        static func BlockWarning(atName: String) -> String {
            return String.localizedStringWithFormat(
                "%@ will not be able to follow you or view your profile, posts or find you in search.",
                atName
            )
        }
    ...
    struct PushNotifications {
        static let PermissionPrompt: String = NSLocalizedString(
            "Ello would like to send you push notifications.\n\nWe will let you know when you have new notifications. You can make changes in your settings.\n",
    ...
    struct Friends {
        static let ImportPermissionTitle: String = NSLocalizedString(
            "Invite some cool people",
            comment: ""
        )
        static let ImportPermissionSubtitle: String = NSLocalizedString(
            "Help Ello grow.",
            comment: ""
        )
        static let ImportPermissionPrompt: String = NSLocalizedString(
            "Ello does not sell user data, and will never contact anyone without your permission.",
            comment: ""
        )
        static let ImportSMS: String = NSLocalizedString("Send Invite", comment: "")
        static let SMSMessage: String = NSLocalizedString(
            "Check out Ello, the Creators Network. https://itunes.apple.com/us/app/ello/id953614327",
            comment: ""
        )
        ...
        static func ImportError(_ message: String) -> String {
            return String.localizedStringWithFormat(
                "We were unable to access your address book\n%@",
                message
            )
        }
        static let AccessDenied: String = NSLocalizedString(
            "Access to your contacts has been denied.  If you want to search for friends, you will need to grant access from Settings.",
            comment: "Access to contacts denied by user"
        )
        static let AccessRestricted: String = NSLocalizedString(
            "Access to your contacts has been denied by the system.",
            comment: "Access to contacts denied by system"
        )

        static let FindAndInvite: String = NSLocalizedString(
            "Find & invite your contacts",
            comment: "Find & invite"
        )

        static let Resend: String = NSLocalizedString(
            "Re-send",
            comment: "invite friends cell re-send"
        )
        static let Invite: String = NSLocalizedString(
            "Invite",
            comment: "invite friends cell invite"
        )
    }
    ...
    struct ImagePicker {
        static let ChooseSource: String = NSLocalizedString(
            "Choose a photo source",
            comment: "choose photo source (camera or library)"
        )
        ...
        static let NoSourceAvailable: String = NSLocalizedString(
            "Sorry, but your device doesn’t have a photo library!",
            comment: "device doesn't support photo library"
        )
        static let TakePhoto: String = NSLocalizedString("Take Photo", comment: "Camera button")
        static let PhotoLibrary: String = NSLocalizedString(
            "Photo Library",
            comment: "Library button"
        )
    ...
    struct WebBrowser {
        static let TermsAndConditions: String = NSLocalizedString(
            "Terms and Conditions",
            comment: "terms and conditions title"
        )
    }
    ...
    struct Startup {
        ...
        static let ForgotPasswordEnter: String = NSLocalizedString(
            "Enter your email",
            comment: "Enter your email label"
        )
        static let ForgotPasswordEnterSuccess: String = NSLocalizedString(
            "If your email address exists in our database, you will receive a password recovery link at your email address in a few minutes.",
            comment: "Enter your email success description"
        )
        static let ForgotPasswordReset: String = NSLocalizedString(
            "Reset your password.",
            comment: "Reset your password label"
        )
        static let ForgotPasswordResetError: String = NSLocalizedString(
            "The password reset token you used is no longer valid. This may be because you requested more than one token, or that too much time has elapsed.",
            comment: "Reset your password long error reason."
        )
        static let Tagline: String = NSLocalizedString(
            "Be part of what’s next in art, design, fashion, web culture & more.",
            comment: "Be part of what's next tag line label"
        )
    }

    struct Login {
        static let Continue: String = NSLocalizedString("Continue", comment: "continue button")
        static let LoadUserError: String = NSLocalizedString(
            "Unable to load user.",
            comment: "Unable to load user message"
        )
        static let ForgotPassword: String = NSLocalizedString(
            "Forgot Password",
            comment: "forgot password title"
        )
        static let UsernamePlaceholder: String = NSLocalizedString(
            "Username or Email",
            comment: "username or email field"
        )
        static let PasswordPlaceholder: String = NSLocalizedString(
            "Password",
    ...
    struct Join {
        static let Discover: String = NSLocalizedString(
            "Discover Ello",
            comment: "discover ello button"
        )
        static let Email: String = NSLocalizedString("Email", comment: "email key")
        static let EmailPlaceholder: String = NSLocalizedString(
            "Enter email",
            comment: "sign up email field"
        )
        static let UsernamePlaceholder: String = NSLocalizedString(
            "Create username",
            comment: "sign up username field"
        )
        ...
        static let PasswordPlaceholder: String = NSLocalizedString(
            "Set password",
            comment: "sign up password field"
        )

        static let LoginAfterJoinError: String = NSLocalizedString(
    ...
    struct Onboard {
        static let PickCategoriesPrimary: String = NSLocalizedString(
            "Pick what you’re into.",
            comment: ""
        )
        static let PickCategoriesSecondary: String = NSLocalizedString(
            "Slow down & check out some cool ass shit.",
            comment: ""
        )
        static let CreateProfilePrimary: String = NSLocalizedString(
            "Grow your creative influence.",
            comment: ""
        )
        static let CreateProfileSecondary: String = NSLocalizedString(
            "Completed profiles get way more views.",
            comment: ""
        )

        static let InviteFriendsPrimary: String = NSLocalizedString(
            "Invite some cool people.",
            comment: ""
        )
        static let InviteFriendsSecondary: String = NSLocalizedString(
            "Make Ello better.",
            comment: ""
        )

        static let CreatorTypeHeader: String = NSLocalizedString(
            "We’re doing a quick survey to find out a little more about the artistic composition of the Ello community.  You can always update your selection(s) in settings.  Thank you!",
            comment: ""
        )
        ...
        static let UploadCoverImagePrompt: String = NSLocalizedString(
            "2560 x 1440\nAnimated Gifs work, too",
            comment: ""
        )
        static let UploadAvatarButton: String = NSLocalizedString("Upload Avatar", comment: "")
        static let UploadAvatarPrompt: String = NSLocalizedString(
            "360 x 360\nAnimated Gifs work, too",
            comment: ""
        )
        ...
        static let UploadFailed: String = NSLocalizedString(
            "Oh no! Something went wrong.\n\nTry that again maybe?",
            comment: "image upload failed during onboarding message"
        )
        static let RelationshipFailed: String = NSLocalizedString(
            "Oh no! Something went wrong.\n\nTry that again maybe?",
            comment: "relationship status update failed during onboarding message"
        )
    }

    struct Share {
        static let FailedToPost: String = NSLocalizedString(
            "Uh oh, failed to post to Ello.",
            comment: "Failed to post to Ello"
        )
        static let PleaseLogin: String = NSLocalizedString(
            "Please login to the Ello app first to use this feature.",
            comment: "Not logged in message."
        )
    }

    struct App {
        static let OpenInSafari: String = NSLocalizedString("Open in Safari", comment: "")
        static let LoggedOut: String = NSLocalizedString(
            "You have been automatically logged out",
            comment: "Automatically logged out message"
        )
        static let LoginAndView: String = NSLocalizedString(
            "Login and view",
            comment: "Login and view prompt"
        )
        static let OldVersion: String = NSLocalizedString(
            "The version of the app you’re using is too old, and is no longer compatible with our API.\n\nPlease update the app to the latest version, using the “Updates” tab in the App Store.",
            comment: "App out of date message"
        )
        static let LoggedOutError: String = NSLocalizedString("You must be logged in", comment: "")
    }

    struct Error {
        static let JPEGCompress: String = NSLocalizedString(
            "Could not compress image as JPEG",
            comment: ""
        )
    }

    static let GenericError: String = NSLocalizedString(
        "Something went wrong. Thank you for your patience with Ello!",
        comment: "Generic error message"
    )
    static let UnknownError: String = NSLocalizedString(
        "Unknown error",
