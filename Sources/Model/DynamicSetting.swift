...
final class DynamicSetAnother: Model {
    ...
    class func fromJSON(_ data: [String: Any]) -> DynamicSetAnother {
        let json = JSON(data)
...
final class DynamicSetting: Model {
    ...
    class func fromJSON(_ data: [String: Any]) -> DynamicSetting {
        let json = JSON(data)
...
extension DynamicSetting {
    static let creatorTypeSetting: DynamicSetting = {
    ...
    static let blockedSetting: DynamicSetting = {
    ...
    static let mutedSetting: DynamicSetting = {
    ...
    static let accountDeletionSetting: DynamicSetting = {
        let label = InterfaceString.Settings.DeleteAccount
        let info = InterfaceString.Settings.DeleteAccountExplanation
        return DynamicSetting(label: label, key: "deleteAccount", info: info)
    }()
}
