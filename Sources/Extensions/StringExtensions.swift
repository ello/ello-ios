...
extension String {
    ...
    func stripHtmlImgSrc() -> String {
        ...
        return srcRegex.stringByReplacingMatches(
            in: self,
            options: .reportCompletion,
            range: range,
            withTemplate:
                "src=\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAAAAAA6fptVAAAACklEQVR4nGNiAAAABgADNjd8qAAAAABJRU5ErkJggg==\""
        )
    }
    ...
    func entitiesEncoded() -> String {
        ...
        for replacement in scalarLookup {
            entitiesEncoded = entitiesEncoded.replacingOccurrences(
                of: replacement.0,
                with: replacement.1
            )
        }
