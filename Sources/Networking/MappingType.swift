...
enum MappingType: String {
    ...
    case activitiesAsNotificationsType = "activities"
    ...
    case notificationsType = "notifications"
    ...
    var singularKey: String {
        switch self {
        case .activitiesAsNotificationsType: return "activity"
        ...
        case .notificationsType:             return "notification"
    ...
    var fromJSON: FromJSONClosure? {
        switch self {
        case .activitiesAsNotificationsType: return Notification.fromJSON
        ...
        case .notificationsType:             return nil
...
extension MappingType {
    var parser: Parser? {
        ...
        case .notificationsType:           return NotificationParser()
