        ...
        describe("ElloURI") {
            ...
            describe("ElloURI.match") {
                    ...
                    let tests: [String: (input: String, outputURI: ElloURI, outputData: String?)] =
                        [
                            ...
                            "with reset password urls": (
                                input:
                                    "https://ello.co/auth/reset-my-password?reset_password_token=abc12--abcdefg12345",
                ...
                describe("app loadable routes with query params") {
                    let tests: [String: (input: String, outputURI: ElloURI, outputData: String)] = [
                        "with Search(query param) urls": (
                            input: "search?terms=%23hashtag", outputURI: .search,
                            outputData: "#hashtag"
                        ),
                        "with SearchPosts(query param) urls": (
                            input: "search/posts/?terms=%23hashtag", outputURI: .searchPosts,
                            outputData: "#hashtag"
                        ),
                        "with SearchUsers(query param) urls": (
                            input: "search/people/?terms=%40hashtag", outputURI: .searchPeople,
                            outputData: "@hashtag"
                        ),
                        "with Find(query param) urls": (
                            input: "find?terms=%23hashtag", outputURI: .search,
                            outputData: "#hashtag"
                        ),
                        "with Profile(query param) urls": (
                            input: "666?expanded=true", outputURI: .profile, outputData: "666"
                        ),
                        "with Post(query param) urls": (
                            input: "777/post/123?expanded=true", outputURI: .post, outputData: "123"
                        ),
                    ]
                ...
                describe("push notification routes") {
                    let tests: [String: (input: String, outputURI: ElloURI, outputData: String)] = [
                        "with URL urls": (
                            input: "notifications/ello.co/wtf/support/featured-members/",
                            outputURI: .pushNotificationURL,
                            outputData: "wtf/support/featured-members/"
                        ),
                        "with User urls": (
                            input: "notifications/users/696", outputURI: .pushNotificationUser,
                            outputData: "696"
                        ),
                        "with Post urls": (
                            input: "notifications/posts/2345", outputURI: .pushNotificationPost,
                            outputData: "2345"
                        ),
                        "with Post Comment urls": (
                            input: "notifications/posts/2345/comments/666",
                            outputURI: .pushNotificationComment, outputData: "2345"
                        ),
                    ]
                ...
                describe("app loadable routes") {
                    let tests: [String: (input: String, outputURI: ElloURI, outputData: String?)] =
                        [
                            "with Search urls": (
                                input: "search", outputURI: .search, outputData: nil
                            ),
                            "with Find urls": (input: "find", outputURI: .search, outputData: nil),
                            "with Profile urls": (
                                input: "666", outputURI: .profile, outputData: "666"
                            ),
                            "with ProfileFollowers urls": (
                                input: "777/followers", outputURI: .profileFollowers,
                                outputData: "777"
                            ),
                            "with ProfileFollowing urls": (
                                input: "888/following", outputURI: .profileFollowing,
                                outputData: "888"
                            ),
                            "with ProfileLoves urls": (
                                input: "999/loves", outputURI: .profileLoves, outputData: "999"
                            ),
                            "with Discover urls": (
                                input: "discover", outputURI: .discover, outputData: "recommended"
                            ),
                            "with DiscoverRandom urls": (
                                input: "discover/random", outputURI: .discoverRandom,
                                outputData: "random"
                            ),
                            "with DiscoverRecent urls": (
                                input: "discover/recent", outputURI: .discoverRecent,
                                outputData: "recent"
                            ),
                            "with DiscoverRelated urls": (
                                input: "discover/related", outputURI: .discoverRelated,
                                outputData: "related"
                            ),
                            "with DiscoverTrending urls": (
                                input: "discover/trending", outputURI: .discoverTrending,
                                outputData: "trending"
                            ),
                            "with Post urls": (
                                input: "666/post/2345", outputURI: .post, outputData: "2345"
                            ),
                            "with Category urls": (
                                input: "discover/art", outputURI: .category, outputData: "art"
                            ),
                            "with Notifications urls": (
                                input: "notifications", outputURI: .notifications, outputData: nil
                            ),
                            "with Notifications/all urls": (
                                input: "notifications/all", outputURI: .notifications,
                                outputData: "all"
                            ),
                            "with Notifications/comments urls": (
                                input: "notifications/comments", outputURI: .notifications,
                                outputData: "comments"
                            ),
                            "with Notifications/loves urls": (
                                input: "notifications/loves", outputURI: .notifications,
                                outputData: "loves"
                            ),
                            "with Notifications/mentions urls": (
                                input: "notifications/mentions", outputURI: .notifications,
                                outputData: "mentions"
                            ),
                            "with Notifications/reposts urls": (
                                input: "notifications/reposts", outputURI: .notifications,
                                outputData: "reposts"
                            ),
                            "with Notifications/relationshiops urls": (
                                input: "notifications/relationships", outputURI: .notifications,
                ...
                describe("known ello root routes") {
                    let tests: [String: (input: String, output: ElloURI)] = [
                        ...
                        "with BetaPublicProfiles urls": (
                            input: "beta-public-profiles", output: .betaPublicProfiles
                        ),
                        ...
                        "with ForgotMyPassword urls": (
                            input: "forgot-password", output: .forgotMyPassword
                        ),
                        "with Friends urls": (input: "friends", output: .friends),
                        "with FreedomOfSpeech urls": (
                            input: "freedom-of-speech", output: .freedomOfSpeech
                        ),
                        ...
                        "with NativeRedirect urls": (
                            input: "native_redirect", output: .nativeRedirect
                        ),
                        "with Noise urls": (input: "noise", output: .noise),
                        "with Onboarding urls": (input: "onboarding", output: .onboarding),
                        "with PasswordResetError urls": (
                            input: "password-reset-error", output: .passwordResetError
                        ),
                        "with RandomSearch urls": (input: "random_searches", output: .randomSearch),
                        "with RequestInvite urls": (
                            input: "request-an-invite", output: .requestInvite
                        ),
                        "with RequestInvitation urls": (
                            input: "request-an-invitation", output: .requestInvitation
                        ),
                        "with RequestInvitations urls": (
                            input: "request_invitations", output: .requestInvitations
                        ),
                        "with ResetPasswordError urls": (
                            input: "auth/password-reset-error", output: .resetPasswordError
                        ),
