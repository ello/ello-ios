                ...
                for (postOwner, canWatch, canReplyAll) in expectations {
                    context("post owner \(postOwner)") {
                        ...
                        beforeEach {
                            ...
                            case .myRepostOtherPost:
                                post = Post.stub([
                                    "author": currentUser, "repostAuthor": otherUser,
                                    "repostContent": [TextRegion(content: "")]
                                ])
                            case .otherRepostMyPost:
                                post = Post.stub([
                                    "author": otherUser, "repostAuthor": currentUser,
                                    "repostContent": [TextRegion(content: "")]
                                ])
                            case .otherRepostOtherPost:
                                post = Post.stub([
                                    "author": otherUser, "repostAuthor": otherUser,
                                    "repostContent": [TextRegion(content: "")]
                                ])
                            }
                        ...
                        it("cell \(canWatch ? "can" : "cannot") watch") {
                            StreamCreateCommentCellPresenter.configure(
                                cell,
                                streamCellItem: item,
