        ...
        describe("Tag") {
            context("parsing HTML") {
                let tests: [String: (input: String, output: String)] = [
                    ...
                    "break tags in a p tag": (
                        input: "<p>test<br><br />", output: "<p>test<br /><br /></p>"
                    ),
                    "entities": (
                    ...
                    "link": (
                        ...
                        output: "test <a href=\"foo.com\">a link</a>"
                    ),
                    "styled text": (
                        input:
            ...
            context("rendering NSAttributedString") {
                ...
                for (name, spec) in tests {
                    it("should render \(name)") {
                        ...
                        let output = tag!.makeEditable().string.replacingOccurrences(
                            of: "\n",
                            with: "\\n"
